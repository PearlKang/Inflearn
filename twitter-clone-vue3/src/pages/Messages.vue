        ...
        >
          ...
          <div class="">
            <div class="flex space-x-1">
              ...
              <div class="text-gray-500">@benkang</div>
              <div class="text-gray-500">7월 20일</div>
            </div>
            <div class="text-gray-500">123123</div>
          </div>
        </div>
      ...
      <div class="flex flex-col h-screen">
        ...
        <div class="flex px-3 h-14 items-center border-b border-gray-100">
          ...
          <div class="">
            ...
            <div class="text-sm text-gray-500">@benkang</div>
          </div>
        </div>
        ...
        >
          <div class="">
            ...
            <span class="text-gray-500">@benkang</span>
          </div>
          <div class="">
          ...
          <div class="">
            ...
            <span class="text-gray-500">2022년 07월</span>
          </div>
        </div>
